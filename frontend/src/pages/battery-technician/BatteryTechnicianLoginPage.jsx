        ...
        <div className="glass-card rounded-3xl p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              ...
              >
                ...
                <input
                  ...
                  placeholder="markus.vance@maxspace.com"
                  autoComplete="email"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl bg-[#173B5C] text-white font-bold text-sm hover:bg-[#102F4A] active:scale-[0.99] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {submitting ? (
                <>
...
export default BatteryTechnicianLoginPage;
